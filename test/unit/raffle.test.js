...
!developementChains.includes(network.name)
    ...
    : describe("Raffle Unit test", () => {
          ...
          describe("enterRaffle", () => {
              ...
              it("emits an event on entering", async () => {
          ...
          describe("fullfillRandomWords", () => {
              ...
              it("picks a winner , resets the lottery , and sends money", async () => {
                  ...
                  const startingAccountIndex = 1 // as the deployer is going to be on the 0th index
                  ...
                  //fulfllrandom words(mock being chainlink vrf)
                  // we will have to wait for the fullfill random words to be called
                      ...
                      raffle.once("WinnerPicked", async () => {
                          ...
                          try {
                              ...
                              assert.equal(
                                  ...
                                  winnerStartingBalance // startingBalance + ( (raffleEntranceFee * additionalEntrants) + raffleEntranceFee )
                                      .add(
                                          raffleEntranceFee
